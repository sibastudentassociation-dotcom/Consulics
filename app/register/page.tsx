...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-white from-primary-700 to-primary-900 flex items-center justify-center px-4 py-6">
      <Toaster />

      <div className="w-full max-w-sm">
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">

          {/* Logo area — dark bg matches logo */}
          ...
          <div className="px-6 py-5">
            ...
            {serverError && (
              <p className="text-red-500 text-xs mb-3 text-center">{serverError}</p>
            )}
